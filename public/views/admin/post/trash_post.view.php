...
<?php admin_get_sidebar(); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-pencil-square-o"></i> Deleted Posts
            </h1>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <a href="<?= route( 'dashboard/post' ); ?>" class="btn btn-primary">View All Posts</a>
                            <a href="<?= route( 'dashboard/post/trash' ); ?>" class="btn btn-danger">View Trash <span class="badge"></span></a>
